...
TOOL_METADATA = {
    "garmin_sync": "Sync latest Garmin activity and health data into the DB. Only use if the user explicitly asks to sync/refresh/update Garmin data — not just because they mention a recent run.",
